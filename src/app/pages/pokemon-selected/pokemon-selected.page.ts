...
export class PokemonSelectedPage implements OnInit {
  ...
  setDefaultSprite() {
    if (
      this.selected?.sprites?.versions?.['generation-v']?.['black-white']
        ?.animated?.front_default
    ) {
      this.currentSprite =
        this.selected.sprites.versions['generation-v'][
          'black-white'
        ].animated.front_default;
  ...
  showAnimatedSprite(
    type: 'front_default' | 'front_shiny' | 'back_default' | 'back_shiny'
  ) {
    if (
      this.selected?.sprites?.versions?.['generation-v']?.['black-white']
        ?.animated
      ...
      const animated =
        this.selected.sprites.versions['generation-v']['black-white'].animated;
